...
*Personal-finance decision analysis · prepared 11 Jul 2026 · horizon 30 years · all figures in EUR · base case: 3% investing vs 3% appreciation*
...
> Under the base-case assumptions, **Lijfrente + rent, then move in (S1)** maximises long-run wealth (€1,945,333 at 30y), and **Rent, then buy normal (S3)** is weakest (€1,744,742).
>
> Ranking: **S1** (€1,945,333) > **S4** (€1,815,872) > **S2** (€1,781,619) > **S3** (€1,744,742). The gap between best and worst is **€200,591** (~11% of net worth). All four scenarios end owning the **same debt-free home**, so *every difference is opportunity cost, financing and fees — not the house itself.*
...
> **Watch the paradox:** S3 has the *lowest* cash out of pocket (€741,548) yet the *lowest* net worth — because it sinks the most capital into a home appreciating at 3% instead of investments earning 3%. Out-of-pocket cost and wealth are not the same thing; opportunity cost is invisible in a bank statement.
...
| Metric | **S1 ✅** | S2 | S3 | S4 |
|---|---|---|---|---|
| Net worth at horizon (nominal) | €1,945,333 | €1,781,619 | €1,744,742 | €1,815,872 |
| Net worth in today's money (PV) | €803,428 | €735,814 | €720,583 | €749,960 |
| Peak monthly housing outflow | €4,773 | €4,875 | €4,368 | €4,416 |
| Peak cumulative funding gap \* | €146,199 | €125,438 | €71,226 | €122,308 |
| Total mortgage interest | €120,683 | €216,738 | €301,159 | €328,148 |
...
*Exhibit 5 — Monthly housing outflow vs. the €3,600 budget. A high line is not the same as unaffordable: when the mortgage is cheaper than investing, the rational choice is to keep cash invested and let it cover the gap. S2 looks heavy (small mortgage + the continuing €2,220/mo annuity), but its true strain is small — its funding gap is only €125,438 because the home-1 sale proceeds sit in the portfolio (Exhibit 6) and cover it.*
...
Ordered best-to-worst on the base-case finances. The financial gaps are modest (~11%) relative to these non-financial factors, which may matter more.

### S1 · Lijfrente + rent, then move in

*Buy the lijfrente home now, rent for 5 years, then move into the lijfrente home and keep it.*

- **Cash-flow strain (high).** For 5 years you pay rent *and* the annuity *and* a mortgage simultaneously — peak outflow €4,773/mo and a cumulative funding gap up to €146,199 that must come from extra savings or income beyond the €3.6k budget.
...
- **Opportunity cost is the catch (high).** €200k plus every spare euro is tied up in an asset appreciating at 3% instead of investments at 3%; the biggest mortgage means €328,148 of interest.
- **Budget is tight long-term (medium).** Mortgage + rising upkeep can exceed the €3.6k budget in later years (funding gap up to €122,308), assuming the budget is not raised with income growth.
...
- **Lowest strain, most flexible (upside).** Comfortably within budget (peak €4,368/mo, no funding gap). Renting keeps you mobile for 5 years and your €200k stays invested and compounding.
...
| Investment return | 3% / yr (nominal) |
